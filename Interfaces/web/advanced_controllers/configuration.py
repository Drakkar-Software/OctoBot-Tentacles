...
from tentacles.Interfaces.web.constants import EVALUATOR_CONFIG_KEY
from . import advanced
from tentacles.Interfaces.web.models.configuration import get_evaluator_detailed_config, \
