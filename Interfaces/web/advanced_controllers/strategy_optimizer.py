...
from tentacles.Interfaces.web.models.configuration import get_config_activated_trading_mode


@advanced.route("/strategy-optimizer")
@advanced.route('/strategy-optimizer', methods=['GET', 'POST'])
def strategy_optimizer():
    from tentacles.Interfaces.web.models.strategy_optimizer import get_strategies_list, \
