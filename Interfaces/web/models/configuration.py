...
def _get_evaluator_config():
    return get_evaluator_config(get_edited_config())


def get_evaluator_startup_config():
    return get_evaluator_config(get_startup_config())


def _get_trading_config():
    return get_trading_config(get_edited_config())


def get_trading_startup_config():
    return get_trading_config(get_startup_config())
...
def get_config_activated_trading_mode(edited_config=False):
    ...
    if edited_config:
        ...
        config[CONFIG_TRADING_TENTACLES] = get_global_config()[CONFIG_TRADING_TENTACLES]
