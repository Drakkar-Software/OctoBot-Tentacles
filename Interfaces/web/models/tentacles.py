...
def get_tentacles_packages():
    ...
    if CONFIG_TENTACLES_KEY in get_global_config():
        for tentacle_package in get_global_config()[CONFIG_TENTACLES_KEY]:
...
def install_packages():
    try:
        tentacles_manager = _get_tentacles_manager(get_global_config())
