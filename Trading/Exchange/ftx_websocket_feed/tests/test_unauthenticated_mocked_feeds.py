...
from ...ftx_websocket_feed import FTXCryptofeedWebsocketConnector
...
async def test_start_spot_websocket():
    ...
    async with websocket_test_tools.ws_exchange_manager(config, FTXCryptofeedWebsocketConnector.get_name()) \
        ...
        await websocket_test_tools.test_unauthenticated_push_to_channel_coverage_websocket(
            ...
            websocket_connector_class=FTXCryptofeedWebsocketConnector,
