...
async def test_order_fill_callback():
    async with _get_tools("BTC/USD", fees=0) as tools:
        ...
        assert newly_created_sell_order.associated_entry_ids == [to_fill_order.shared_signal_order_id]
        ...
        assert newly_created_buy_order.associated_entry_ids == [to_fill_order.shared_signal_order_id]
