...
class ArbitrageContainer:
    # 0.3 %
    SIMILARITY_RATIO = 0.003

    def __init__(self, own_exchange_price, target_price, state):
        self.own_exchange_price = own_exchange_price
        self.target_price = target_price
        self.state = state
        self.passed_initial_order = False
        self.initial_before_fee_filled_quantity = None
        self.initial_limit_order_id = None
        self.secondary_limit_order_id = None
        self.secondary_stop_order_id = None

    def is_similar(self, own_exchange_price, state):
