...
$tentacle_description: {
    ...
    "subtype": "Mode",
    "version": "1.0.0",
    "requirements": ["move_signals_strategy_evaluator"],
...
class SignalTradingMode(AbstractTradingMode):
    DESCRIPTION = "SignalTradingMode is a low risk trading mode adapted to flat markets."
...
class SignalTradingModeCreator(AbstractTradingModeCreator):
...
class SignalTradingModeDecider(AbstractTradingModeDecider):
